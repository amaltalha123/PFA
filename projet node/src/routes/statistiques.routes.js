...
const {getTotalStagiaires,getTotalEncadrant,getTotalActualStage,getTotalfinishedStage,getTotalEncadrantOwnStage,StageByType,getTotalStagiaireOwnStages} = require('../controllers/statistiques.controller');
